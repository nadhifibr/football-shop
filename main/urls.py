...
from main.views import update_product_entry_ajax
from main.views import delete_product_ajax
from main.views import logout_user_ajax
...
urlpatterns = [
    ...
    # path('product/<uuid:id>/edit', edit_product, name='edit_product'), path('product/<uuid:id>/delete', delete_product, name='delete_product'), path('logout/', logout_user, name='logout'),